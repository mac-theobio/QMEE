...
> Perhaps the average user of significance tests, without knowing it, smears him- or herself over the three major statistical schools, and disobeys the rules of each: we act as if Fisherian and often believe we are; attempt Neymann-Pearson [sic] approaches, but never properly; and interpret tests in a Bayesian fashion.

> In theory, hypothesis testing is not about decision making--decision theory is available for that. In practice, however, statistics and hypothesis testing cannot wriggle out of the patently obvious fact that they can be used, and often are used, as decision-making procedures
