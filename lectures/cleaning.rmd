...
<!--- COMMENT
2019 May 16 (Thu)
Now making a separate version is statistics_talks repo
-->
...
```{r echo=FALSE}
load("~/gitroot/disease_model_talks/live.RData")
sim <- as.tibble(sim)
```
...
```{r echo=FALSE}
religTab <- (
	read.table("~/gitroot/Circumcision_and_behaviour/religion_basic.ccsv"
