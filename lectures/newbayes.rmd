...
* build-your-own model (McCarthy, McElreath, Clark)
* better handling of uncertainty/error propagation (Elderd et al; Ludwig)
* informative priors for data-poor decisions (McCarthy)
