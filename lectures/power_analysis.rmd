...
> - how big does your experiment need to be? [@lakensSample2022]
...
https://bbolker.github.io/powertargets/powertargets.html

```{r pt1, echo = FALSE}
knitr::include_graphics("../pix/powertargets1.png")
```

## power of clarity

```{r pt2, echo = FALSE}
knitr::include_graphics("../pix/powertargets2.png")
```
