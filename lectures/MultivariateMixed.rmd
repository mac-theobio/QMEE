...
**Alternatives**: many univariate models with multiplicity correction (e.g. differential expression analysis); collapse variables to summary statistics (diversity metrics, principal components)

## examples

* morphometric measurements (e.g. head breadth, head length, snout-vent length)
* morphometric 'landscapes' (e.g. vein intersections on a fly wing)
