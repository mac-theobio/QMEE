...
> - Independence
> - **Response variables** are linear functions of **predictor** (derived) variables, in turn based on **input** (observed) variables ("independent"/"dependendent")
...
> - You need to pick a fixed point (see Schielzeth 2010), or average in some way 
...
> - Bear road-crossing [@karelusEffects2017]
...
```{r DHARMa, fig.height = 5, fig.width=10}
