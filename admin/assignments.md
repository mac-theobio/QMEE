...
You are allowed to use generative AI/large language models (Claude, ChatGPT, Gemini, Copilot, etc. etc.) for any component of this course. However:
...
- we strongly discourage you to limit your use of LLMs, especially when you're learning R or basic stats
...
- these guidelines (citation, personal responsibility) also apply to material taken from Stack Overflow or other forums
